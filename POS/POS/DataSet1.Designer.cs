...
namespace POS {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string Product_Name, int Stock, decimal Price) {
...
namespace POS.DataSet1TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([ID] = @Original_ID) AND ((@IsNull_Product_Name = 1 AND [Product_Name] IS NULL) OR ([Product_Name] = @Original_Product_Name)) AND ((@IsNull_Stock = 1 AND [Stock] IS NULL) OR ([Stock] = @Original_Stock)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Product_Name], [Stock], [Price]) VALUES (@Product_" +
                "Name, @Stock, @Price);\r\nSELECT ID, Product_Name, Stock, Price FROM Products WHER" +
                "E (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Product_Name] = @Product_Name, [Stock] = @Stock, [Price] = @Price WHERE (([ID] = @Original_ID) AND ((@IsNull_Product_Name = 1 AND [Product_Name] IS NULL) OR ([Product_Name] = @Original_Product_Name)) AND ((@IsNull_Stock = 1 AND [Stock] IS NULL) OR ([Stock] = @Original_Stock)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)));
SELECT ID, Product_Name, Stock, Price FROM Products WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::POS.Properties.Settings.Default.ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Product_Name, Stock, Price FROM dbo.Products";
        ...
        public virtual int Update(string Product_Name, global::System.Nullable<int> Stock, global::System.Nullable<decimal> Price, int Original_ID, string Original_Product_Name, global::System.Nullable<int> Original_Stock, global::System.Nullable<decimal> Original_Price, int ID) {
            if ((Product_Name == null)) {
        ...
        public virtual int Update(string Product_Name, global::System.Nullable<int> Stock, global::System.Nullable<decimal> Price, int Original_ID, string Original_Product_Name, global::System.Nullable<int> Original_Stock, global::System.Nullable<decimal> Original_Price) {
            return this.Update(Product_Name, Stock, Price, Original_ID, Original_Product_Name, Original_Stock, Original_Price, Original_ID);
        }
    }
